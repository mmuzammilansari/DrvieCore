...
function newFunction() {
	window.addEventListener('scroll', () => {
	  ...
	  // Get all elements with class 'animate__animated'
	  const elements = document.getElementsByClassName('animate__animated');
	  
	  // Loop through the elements and add the 'animate-on-scroll' class to each
  ...
  // Call the newFunction() to initialize the scroll animation
  newFunction();
