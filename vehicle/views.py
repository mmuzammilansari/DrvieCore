...
OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "mmuzammilansar/DriveCore")
OLLAMA_API_KEY = os.getenv("OLLAMA_API_KEY", "YOUR_API_KEY_HERE")
            ...
            messages=[
                {
                    "role": "system",
                    "content": """
You are DriveCore AI Assistant. Rules: 
- Always answer as DriveCore support assistant. 
- Only answer about vehicle breakdown assistance. 
- Keep answers short, practical, and customer-support style. 
- If needed, ask for vehicle type, location, and issue. -
 If user asks unrelated questions, redirect to DriveCore services. 
 DriveCore Services: 
 - Emergency towing 
 - Flat tire replacement 
 - Battery jump start 
 - Fuel delivery 
 - On-site mechanic inspection 
 - Minor repair support 
 - Vehicle recovery 
 - Service booking 
 - Mechanic arrival estimate 
 - Pricing guidance 
 ...
 - Customer complaint support """
        ...
        return f"DriveCore chatbot error: {str(e)}"
...
def chatbot(request):
    ...
    return render(request, "vehicle/chatbot.html", {
        "form": form,
        "chats": chats
    })